...
function toProductRow(
  ...
  return {
    ...
    usage_instructions_en: form.usageInstructionsEn.trim(),
    usage_instructions_ar: form.usageInstructionsAr.trim(),
    seo_title_en: form.seoTitleEn.trim(),
    seo_title_ar: form.seoTitleAr.trim(),
    seo_description_en: form.seoDescriptionEn.trim(),
    seo_description_ar: form.seoDescriptionAr.trim(),
...
export function mapProductRecordToForm(
  ...
  return {
    ...
    groupId: record.product.group_id ?? "",
    ...
    usageInstructionsEn: record.product.usage_instructions_en,
    usageInstructionsAr: record.product.usage_instructions_ar,
    seoTitleEn: record.product.seo_title_en,
    seoTitleAr: record.product.seo_title_ar,
    seoDescriptionEn: record.product.seo_description_en,
    seoDescriptionAr: record.product.seo_description_ar,
    stockStatus: record.product.stock_status,
    isBestSeller: record.product.is_best_seller,
    displayOrder: record.product.display_order,
